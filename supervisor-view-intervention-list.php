...
<body>
    <div class="container">
	   <div class="no-gutter row"> 
           <div class="col-md-12">
               <div class="panel panel-default" id="IV_PANEL">
		...
		$count = mysqli_num_rows($result);
						...
						while ($row = mysqli_fetch_array($result)) 
						{
							echo '
								...
								if ($row['is_successful'] === null){
									$btn_yes_cls = '';
									$btn_no_cls = '';
								} elseif ($row['is_successful']){
									$btn_yes_cls = 'active';
									$btn_no_cls = '';
								} else {
									$btn_yes_cls = '';
								...
								echo "
									<button class='btn btn-primary feedback-btn $btn_yes_cls' data-feedback='1' data-intervention_id='{$row['intervention_id']}'>successful</button>
									<button class='btn btn-danger feedback-btn $btn_no_cls' data-feedback='0' data-intervention_id='{$row['intervention_id']}'>failed</button> 		
								";
								echo '</div>';
								echo '</td>';	
								echo '</tr>';
   ...
   <script src="assets/js/lib/data-table/datatables.min.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
		  ...
		  $('#IV_PANEL').on('click','.feedback-btn', function(event){
