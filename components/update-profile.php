<?php
    ...
    if(isset($_POST)){
        ...
        $sql1="UPDATE user SET user_avatar='$BackgroundNewImageName' WHERE user_username = '$temp'";
        $sql2="INSERT INTO user (user_avatar) VALUES ('$BackgroundNewImageName') WHERE user_username = '$temp'";
