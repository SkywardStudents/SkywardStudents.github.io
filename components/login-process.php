<?php
    ...
    if(isset($_REQUEST['login_button'])||$_REQUEST['auto']==1){
        ...
        $sql="SELECT user_id,user_username,user_password, user_level, class FROM user WHERE user_username='$username'AND user_password='$password'";
