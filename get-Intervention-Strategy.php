...
if(!empty($_POST["studentid"])){
    ...
    $query = $db->query("SELECT * FROM student_behaviour WHERE group_id = ".$_POST['group_id']." ");
    ...
    //Fetch all state data
    $query = $db->query("SELECT * FROM student_behaviour WHERE conduct_id = ".$_POST['conduct_id']." ");
