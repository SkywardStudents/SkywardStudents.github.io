                                                                            ...
                                                                            <div id="panel-element-<?php echo $rws['user_id']; ?>" class="panel-collapse collapse in">
                                                                                <div class="panel-body">
                                                                                    <div class="col-md-6 column">
                                                                                        <img src="userfiles/avatars/<?php echo $rws['user_avatar'];?>" name="aboutme" class="img-responsive" width = "80" height = "100">                                  
                                                                                    </div>
                                                                                    <div class="col-md-6 column">
                                                                                   ...
                                                                                   <h6><span><?php echo $rws['user_profession'];?></a></span></h6>
																				   </div>
