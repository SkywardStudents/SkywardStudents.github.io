<?php
    $current_user = $_SESSION['user_username'];
     $sql = "SELECT * FROM user WHERE user_username='$current_user' AND user_profession = 'Teacher'";
...
?>
    <!-- Navbar1 -->
	           ...
	           <ul class="nav navbar-nav">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                             <li>
                                <a href="all-students.php"><i class="fa fa-edit"></i> View My Students</a>
                            </li>
							<li>
		...
		<div class="topnavg">
		 ...
		 <a href="teacher-student-list.php">Students</a>
		 <a href="teacher-student-360.php">Behaviour</a>
		 <a href="teacher-student-record.php">Intervention</a>
		 <a href="teacher-student-assign.php">Intervention</a>
